...
service_account_service.get_credits = async function (id) {
    try {
        let result = await external_api.get('/api/service_accounts/' + id + '/credits');
        return result;
    }
    catch (err) {
        throw err;
...
service_account_service.post_credit = async function (id, credit_request) {
    try {
        let result = await external_api.post('/api/service_accounts/' + id + '/credits', credit_request);
        return result;
    }
    catch (err) {
        throw err;
